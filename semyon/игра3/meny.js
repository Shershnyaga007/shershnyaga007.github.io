var meny = function (mouAtac, curPos){
	...
	var item1 = game.newImageObject({
		file: "block.png", h : 50, w : 50,
		x : camera.getPosition().x+width-100, y : camera.getPosition().y + 200,
		iti : curPos
	})
	...
	if (mou == 0){
		if (mouse.isPeekObject('LEFT', item1)){texture = 1}
